...
interface EditIncomeOperationDialogProps {
...
function EditIncomeOperationDialog({ operation, isOpen, onOpenChange, deleteClicked }: EditIncomeOperationDialogProps) {
      ...
      <DialogContent className="flex flex-col gap-2">
        ...
        <Form {...form}>
          <form className="flex flex-col gap-2" onSubmit={form.handleSubmit(onDataSubmit)}>
            ...
            <Button onClick={handleDelete} type="button" variant={"destructive"}><Trash2Icon className="w-4 h-4 mr-2" /> Delete operation</Button>
...
export default EditIncomeOperationDialog;
